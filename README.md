...
- **Expense Queries**: Ask questions like "How much on groceries this month?"
...
The bot handles four types of interactions:

| Intent | Examples | Action |
|--------|----------|--------|
| **LOG** | "Spent $50 at Costco", "Y paid $30 for groceries" | Records expense to sheet |
| **QUERY** | "How much on groceries?", "What did we spend in June?" | Returns filtered totals |
...
gcloud functions deploy expense-bot-v2 \
  ...
  --set-env-vars GEMINI_API_KEY=...,META_TOKEN=...,META_PHONE_ID=...,VERIFY_TOKEN=...
```

See [deploy_command.md](deploy_command.md) for detailed deployment instructions.
